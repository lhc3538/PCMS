...
Begin VB.Form Form1 
   ...
   Begin VB.Image Image1 
      Height          =   900
      Left            =   10440
      MouseIcon       =   "Form1.frx":87C2
      MousePointer    =   99  'Custom
      Picture         =   "Form1.frx":908C
      Top             =   2040
      Width           =   315
   End
   Begin VB.Image Image2 
      Height          =   345
      Left            =   7440
      MouseIcon       =   "Form1.frx":966D
      MousePointer    =   99  'Custom
      Picture         =   "Form1.frx":9F37
      Top             =   2160
      Width           =   1035
   End
...
p1.Picture = LoadPicture("c:\SGxt\ico\主界面" & T_BH1.Text & ".jpg")
T_BH.Text = "0"
T_BH1.Text = T_BH1.Text + 1
End If
End Sub

Private Sub T_BH1_Change()
If T_BH1.Text = "7" Then
T_BH1.Text = "0"
End If
End Sub
...
'图片的载入
p1.Picture = LoadPicture("c:\sgxt\ico\主界面0.jpg")
P_adver.Picture = LoadPicture("c:\sgxt\adver\adver.jpg")
'窗体置顶
 Dim rtn As Long
...
Dim shell_2
shell_2 = Shell("C:\sgxt\pp.exe", vbNormalFocus)
End
Else
Me.Caption = "得到焦点"
End If
